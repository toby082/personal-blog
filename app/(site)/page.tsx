...
export default async function Home() {
  ...
  return (
    <div className="pb-10">
      <HeroSimple
        title="Embrace new tech and skills to digitalize more things  🌴."
        subtitle="I'm Toby. Frontend engineer writing code and blog on the internet."
      />
      ...
      {aboutPage && (
        <div className="container max-w-6xl">
          <h2 className="mb-8 font-heading text-4xl font-bold">Who&apos;s this person again?</h2>
          <div className="grid grid-cols-1 place-items-start justify-between gap-12 lg:grid-cols-3">
